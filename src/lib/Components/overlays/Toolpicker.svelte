<script lang="ts">
	...
	export let value: 'shovel' | 'flag' = 'shovel';
</script>

<div class="fixed right-1 bottom-1">
	<RadioGroup fill="white">
		<RadioItem bind:group={value} name="tool" value={'shovel'} class="fill-current text-white-500"
			...
			></RadioItem
		>
		<RadioItem bind:group={value} name="tool" value={'flag'} class="fill-current text-white-500"
