const customCrimson = {
	...
	properties: {
		...
		'--color-primary-100': '227 217 237',
		'--color-primary-200': '198 178 220',
		'--color-primary-300': '172 143 204',
		'--color-primary-400': '144 105 186',
		'--color-primary-500': '116 74 161',
		'--color-primary-600': '93 59 129',
		'--color-primary-700': '71 45 98',
